...
export default function Header({ query, setQuery }) {
  ...
  return (
    <header className="fixed top-0 right-0 left-0 z-50 bg-white text-black px-4 py-3 shadow-md dark:bg-gray-900 dark:text-white border-b-2 dark:border-gray-800">
